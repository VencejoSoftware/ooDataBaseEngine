...
type
  TFirebird25EngineTest = class sealed(TTestCase)
  strict private
...
procedure TFirebird25EngineTest.ExecuteReturningReturnDataset;
var
...
procedure TFirebird25EngineTest.ExecuteReturnFailedExecution;
var
  ExecutionResult: IExecutionResult;
begin
...
procedure TFirebird25EngineTest.IsConnectedIsFalse;
begin
...
procedure TFirebird25EngineTest.IsConnectedIsTrue;
begin
  CheckTrue(_DatabaseEngine.IsConnected)
end;

procedure TFirebird25EngineTest.ExecuteReturningReturnGeneratedID;
var
  ExecutionResult: IExecutionResult;
  Dataset: TDataSet;
begin
...
procedure TFirebird25EngineTest.ExecuteReturningReturnGeneratedID2;
var
  ExecutionResult: IExecutionResult;
  Dataset: TDataSet;
begin
...
procedure TFirebird25EngineTest.UseGlobalTransactionAndRollbackNotReturnRecords;
var
  ExecutionResult: IExecutionResult;
begin
...
procedure TFirebird25EngineTest.PrivateTransactionAutoCommitReturnRecord;
var
  ExecutionResult: IExecutionResult;
begin
  CheckFalse(_DatabaseEngine.InTransaction);
...
procedure TFirebird25EngineTest.SetUp;
const
...
procedure TFirebird25EngineTest.TearDown;
begin
  inherited;
...
RegisterTests('Firebird test', [TFirebird25EngineTest {$IFNDEF FPC}.Suite {$ENDIF}]);
